...
namespace SecretariaDeEscuelas.Controllers
{
    public class CarrerasController : Controller
    {
        ...
        public JsonResult ObtenerCarreras(int instituto)
        {
            var carreras = _context.Carreras.ToList().Where(x => x.InstitutoId == instituto);
            return Json(new SelectList(carreras, "Id", "Nombre"));
        }
